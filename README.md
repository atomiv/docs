...
## What are the key principles of Atomiv?
...
## What are the key features of the Atomiv?
...
1. Install the Atomiv Template via NuGet [https://docs.optivem.com/framework/development/](https://docs.optivem.com/framework/development/) which creates a new Visual Studio solution, with all the layers: Core Layer, Infrastructure Layer, Web Layer, Test Layer
...
## What are the next steps to implement the Atomiv?
